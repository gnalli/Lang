...
const section = BLOG_SECTIONS.ops
...
export default function OpsPage() {
  const { posts, tags } = buildTopicPageData(allBlogs, "ops")

  return <TopicPageShell icon={Feather} title={section.title} posts={posts} tags={tags} />
}
